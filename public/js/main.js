...
socket.on('join_room_response',function(payload){
	...
	if(dom_elements.length == 0){
		var nodeA = $('<div></div');
		nodeA.addClass('socket_'+payload.scoket_id);

		var nodeB = $('<div></div');
		nodeB.addClass('socket_'+payload.scoket_id);

		var nodeC = $('<div></div');
		nodeC.addClass('socket_'+payload.scoket_id);
...
socket.on('player_disconnected',function(payload){
	...
	/*If someone left the room then aanimate out all ther content */
	var dom_elements = $('.socket_'+payload.socket_id);
